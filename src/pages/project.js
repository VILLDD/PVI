        ...
        <section id="project" className="h-full bg-[#222831] items-center justify-center p-5 sm:p-15" style={{ fontFamily: "'Lexend', sans-serif" }}>
            <div className="flex gap-15 justify-center sm:justify-between w-full">
                ...
                <motion.div initial={{ opacity: 0, x: 100 }}
                    ...
                    <h1 className="text-center p-2 sm:p-5 text-2xl sm:text-4xl font-bold selection:bg-transparent">Web 2.0</h1>
            ...
            <div className="flex gap-15 justify-center sm:justify-between w-full mt-15">
                <motion.div initial={{ opacity: 0, x: -100 }}
                    ...
                    <h1 className="text-center p-2 sm:p-5 text-2xl sm:text-4xl font-bold selection:bg-transparent">New Port</h1>
                    <p className=" text-center p-2 sm:p-5 text-sm sm:text-lg selection:bg-transparent">
                        ...
                        tapi sejak saya beli laptop saya belajar banyak sekali hal hal baru di pemrograman. Dulu di HP saya cuma belajar HTML dan CSS.
                    </p>
            ...
            <div className="flex gap-15 justify-center sm:justify-between w-full mt-15">
                ...
                <motion.div initial={{ opacity: 0, x: 100 }}
                    ...
                    viewport={{ once: true, amount: 0.2 }}
                    className=" bg-[#393E46] h-70 w-3/4 rounded-3xl shadow-xl cursor-pointer transition-colors duration-300 active:bg-white active:text-black text-white active:shadow-white active:shadow-lg">
                    <h1 className="text-center p-2 sm:p-5 text-2xl sm:text-4xl font-bold selection:bg-transparent">TinLine.</h1>
                    <p className="text-center p-5 text-sm sm:text-lg selection:bg-transparent">
                        ...
                        namun project ini masih dalam tahap perancangan dan design dari website TinLine. ini masih berupa sketsa Figma.
                    </p>
                </motion.div>
            </div>
        </section>
